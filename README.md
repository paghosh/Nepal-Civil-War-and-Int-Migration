...
# Structure of Code
The folder [Source Code](/source_code/) contains different code files: [Master](/source_code/00_master.R) [Setup](/source_code/01_setup.R)  [Data Cleaning](/source_code/02_data_cleaning.R)  [Summary](/source_code/03_summary_statistics.R) [Main Regression](/source_code/04_regression_main.R) [Robustness Check](/source_code/05_robustness.R) [Mechanism Analysis](/source_code/06_mechanism_analysis.R) and [Helper Function](/source_code/Helper_functions.R)  to clean the data, generate summary, run main regression