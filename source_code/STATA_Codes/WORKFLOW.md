...
Run the STATA code in the *![00_Master_File](/source_code/STATA_Codes/00_Master_File.do)* which will run all the other codes from the codes *01_Conflict_Data.do* to *04_Personal_NLFS.do*. Remember to change the path.<br>
